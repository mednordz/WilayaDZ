...
(async()=>{
 ...
 for(const [width,lang,theme] of [[320,'fr','dark'],[360,'ar','dark'],[415,'fr','dark'],[415,'bi','dark'],[415,'ar','light'],[768,'fr','dark']]){
  ...
  const title=await page.locator('.banner-text h1').boundingBox();
  assert(title.y>=banner.y&&title.y+title.height<=banner.y+banner.height,'Title stays inside banner');
