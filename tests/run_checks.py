...
for test in ['test_header','test_connection_methods','test_google_browser','test_settings','test_map','test_design_pages','test_visual_parcours','test_ladder','test_rive']:
