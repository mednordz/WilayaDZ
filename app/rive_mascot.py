...
def build(character):
 ...
 o(1,p4=character.capitalize(),p7=float(w+40),p8=float(h+40))
 ...
 if character == 'cigogne':
  # Smaller vertical motion keeps the long legs grounded; the neck leads the gesture.
  anim('Idle',300,1,[(1,17,[(0,1),(75,1.006),(150,1),(225,1.005),(300,1)]),(3,15,[(0,0),(75,-.018),(150,0),(225,.018),(300,0)])])
  anim('Celebrate',90,0,[(1,14,[(0,h+20),(22,h+15),(45,h+20),(65,h+17),(90,h+20)]),(3,15,[(0,0),(22,-.065),(45,.045),(65,-.025),(90,0)])])
  anim('Encourage',96,0,[(3,15,[(0,0),(30,.065),(60,.04),(96,0)]),(1,17,[(0,1),(30,.993),(96,1)])])
  anim('Curious',120,0,[(3,15,[(0,0),(30,-.065),(72,-.065),(120,0)])])
 else:
 ...
 dest=root/'assets/rive';dest.mkdir(parents=True,exist_ok=True);(dest/(character+'.riv')).write_bytes(b)
 print(character, len(b))

if __name__ == '__main__':
 for character in ['fennec','cigogne']: build(character)
